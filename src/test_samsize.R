...
mod.sam.5e5 <- list(id = 0:2,
                    ...
                    paraPen = rep(list(P = list(rank(9), diag(9))), 3),
...
mod.sam.2e6 <- list(id = 0:2,
                    ...
                    predictor = c(
                                  "P",
                                  paste("P",
                                        "s(ed_east, ed_north, bs = 'gp', k = 1000)",
                                        sep = " + "),
                                  paste("P",
                                        "s(som.x, som.y, bs = 'gp', k = 1000)",
                                        "s(som.x, som.y, bs = 'gp', by = adm0, k = 1000)",
                                        "s(adm0, bs = 're')",
                                        "s(ed_east, ed_north, bs = 'gp', k = 1000)",
                                        sep = " + ")
                                 ),
...
mod.sam.5e6 <- list(id = 0:2,
                    ...
                    predictor = c(
                                  "P",
                                  paste("P",
                                        "s(ed_east, ed_north, bs = 'gp', k = 1500)",
                                        sep = " + "),
                                  paste("P",
                                        "s(som.x, som.y, bs = 'gp', k = 1500)",
                                        "s(som.x, som.y, bs = 'gp', by = adm0, k = 1500)",
                                        "s(adm0, bs = 're')",
                                        "s(ed_east, ed_north, bs = 'gp', k = 1500)",
                                        sep = " + ")
                                 ),
...
mod.sam.1e7 <- list(id = 0:2,
                    ...
                    predictor = c(
                                  "P",
                                  paste("P",
                                        "s(ed_east, ed_north, bs = 'gp', k = 2000)",
                                        sep = " + "),
                                  paste("P",
                                        "s(som.x, som.y, bs = 'gp', k = 2000)",
                                        "s(som.x, som.y, bs = 'gp', by = adm0, k = 2000)",
                                        "s(adm0, bs = 're')",
                                        "s(ed_east, ed_north, bs = 'gp', k = 2000)",
                                        sep = " + ")
                                 ),
...
fm.cam.1e7 <- fit_models(mod.sam.1e7, cam.mod, 5e3, res.path, "cam.1e7.m")
