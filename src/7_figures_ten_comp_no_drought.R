...
file.data.vis <- paste0(path.data.vis, "tenure_comp", hurr_suf, ".no_drought.rds")
file.fig.ten.comp <- paste0(path.figures, "ten.comp", hurr_suf, ".no_drought.png")
file.fig.ten.comp.c <- paste0(path.figures, "ten.comp.c", hurr_suf, ".no_drought.png")
file.table.ten.comp <- paste0(path.data.vis, "tenure_comp", hurr_suf, ".no_drought.csv")
...
if(!file.exists(file.data.vis) | overwrite == TRUE) {
  ...
  for(i in seq_along(regions)) {
    ...
    name.mar.ten_comp.rec.sam <- paste0(region, ".ten_comp.rec.all", hurr_suf_mar, ".no_drought.rds")
    name.mar.ten_comp.recov.sam <- paste0(region, ".ten_comp.rec.ov", hurr_suf_mar, ".no_drought.rds")
    name.mar.ten_comp.ind.sam <- paste0(region, ".ten_comp.ind.all", hurr_suf_mar, ".no_drought.rds")
    name.mar.ten_comp.indov.sam <- paste0(region, ".ten_comp.ind.ov", hurr_suf_mar, ".no_drought.rds")
    name.mar.ten_comp.def.rec <- paste0(region, ".def.ten_comp.rec.all", hurr_suf_mar, ".no_drought.rds")
    file.mar.ten_comp.def.rec <- paste0(path.marginal, region, "/", name.mar.ten_comp.def.rec)
    name.mar.ten_comp.deg.rec <- paste0(region, ".deg.ten_comp.rec.all", hurr_suf_mar, ".no_drought.rds")
    file.mar.ten_comp.deg.rec <- paste0(path.marginal, region, "/", name.mar.ten_comp.deg.rec)
    name.mar.ten_comp.def.recov <- paste0(region, ".def.ten_comp.rec.ov", hurr_suf_mar, ".no_drought.rds")
    file.mar.ten_comp.def.recov <- paste0(path.marginal, region, "/", name.mar.ten_comp.def.recov)
    name.mar.ten_comp.deg.recov <- paste0(region, ".deg.ten_comp.rec.ov", hurr_suf_mar, ".no_drought.rds")
    file.mar.ten_comp.deg.recov <- paste0(path.marginal, region, "/", name.mar.ten_comp.deg.recov)
    name.mar.ten_comp.def.ind <- paste0(region, ".def.ten_comp.ind.all", hurr_suf_mar, ".no_drought.rds")
    file.mar.ten_comp.def.ind <- paste0(path.marginal, region, "/", name.mar.ten_comp.def.ind)
    name.mar.ten_comp.deg.ind <- paste0(region, ".deg.ten_comp.ind.all", hurr_suf_mar, ".no_drought.rds")
    file.mar.ten_comp.deg.ind <- paste0(path.marginal, region, "/", name.mar.ten_comp.deg.ind)
    name.mar.ten_comp.def.indov <- paste0(region, ".def.ten_comp.ind.ov", hurr_suf_mar, ".no_drought.rds")
    file.mar.ten_comp.def.indov <- paste0(path.marginal, region, "/", name.mar.ten_comp.def.indov)
    name.mar.ten_comp.deg.indov <- paste0(region, ".deg.ten_comp.ind.ov", hurr_suf_mar, ".no_drought.rds")
...
png(file.fig.ten.comp.c, width = 5.5, height = 2.75, unit = "in", res = 600)
# p.comb
p.area.prop + plot_annotation(tag_levels = list(c("A", "B")))
dev.off()
