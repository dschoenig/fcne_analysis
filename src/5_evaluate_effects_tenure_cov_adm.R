...
file.effects <- paste0(path.effects, region, ".risk.tenure_cov_adm.rds")
...
extent_by_som <- 
  data.table(
    ...
    group_vars = list(c("adm0", "som_bmu", "som_x", "som_y", "it_type", "pa_type"), 
                      c("adm0", "som_bmu", "som_x", "som_y"), 
                      c("adm0", "som_bmu", "som_x", "som_y", "it_type"), 
                      c("adm0", "som_bmu", "som_x", "som_y"), 
                      c("adm0", "som_bmu", "som_x", "som_y", "pa_type"), 
                      c("adm0", "som_bmu", "som_x", "som_y", "it_type", "pa_type", "overlap")))
...
som.units[, `:=`(group.id = 1:nrow(som.units),
                 group.label = paste0(adm0, ":", som_bmu))]
som.units[, extent := factor(extent, levels = extent_by_som$extent)]
setcolorder(som.units, c("extent", "group.label", "adm0", "it_type", "pa_type",
