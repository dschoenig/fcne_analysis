...
file.data.vis <- paste0(path.data.vis, "tenure_adm", hurr_suf, ".no_drought.rds")
file.fig.ten <- paste0(path.figures, "ten.full", hurr_suf, ".no_drought.png")
file.fig.ten.reg.c <- paste0(path.figures, "ten.full.reg.c", hurr_suf, ".no_drought.png")
file.fig.ten.reg <- paste0(path.figures, "ten.full.reg", hurr_suf, ".no_drought.png")
file.fig.ten.reg.av <- paste0(path.figures, "ten.full.reg.av", hurr_suf, ".no_drought.png")
file.fig.ten.area <- paste0(path.figures, "ten.full.area", hurr_suf, ".no_drought.png")
file.fig.ten.area.c.amz <- paste0(path.figures, "ten.full.area.c.amz", hurr_suf, ".no_drought.png")
file.fig.ten.area.c.cam <- paste0(path.figures, "ten.full.area.c.cam", hurr_suf, ".no_drought.png")
file.fig.ten.av <- paste0(path.figures, "ten.full.av", hurr_suf, ".no_drought.png")
file.fig.ten.def <- paste0(path.figures, "ten.full.def", hurr_suf, ".no_drought.png")
file.fig.ten.deg <- paste0(path.figures, "ten.full.deg", hurr_suf, ".no_drought.png")
file.fig.ten.def.av <- paste0(path.figures, "ten.full.def.av", hurr_suf, ".no_drought.png")
file.fig.ten.deg.av <- paste0(path.figures, "ten.full.deg.av", hurr_suf, ".no_drought.png")
file.fig.ten.post.def.cam <- paste0(path.figures, "ten.full.post.def.cam", hurr_suf, ".no_drought.png")
file.fig.ten.post.deg.cam <- paste0(path.figures, "ten.full.post.deg.cam", hurr_suf, ".no_drought.png")
file.fig.ten.post.def.amz <- paste0(path.figures, "ten.full.post.def.amz.no_drought.png")
file.fig.ten.post.deg.amz <- paste0(path.figures, "ten.full.post.deg.amz.no_drought.png")
file.fig.ten.av.post.def.cam <- paste0(path.figures, "ten.full.av.post.def.cam", hurr_suf, ".no_drought.png")
file.fig.ten.av.post.deg.cam <- paste0(path.figures, "ten.full.av.post.deg.cam", hurr_suf, ".no_drought.png")
file.fig.ten.av.post.def.amz <- paste0(path.figures, "ten.full.av.post.def.amz.no_drought.png")
file.fig.ten.av.post.deg.amz <- paste0(path.figures, "ten.full.av.post.deg.amz.no_drought.png")
...
if(!file.exists(file.data.vis) | overwrite == TRUE) {
  ...
  for(i in seq_along(regions)) {
    ...
    name.mar.ten.sam <- paste0(region, ".ten.itpa.all", hurr_suf_mar, ".no_drought.rds")
    name.mar.ten.def <- paste0(region, ".def.ten.itpa.all", hurr_suf_mar, ".no_drought.rds")
    file.mar.ten.def <- paste0(path.marginal, region, "/", name.mar.ten.def)
    name.mar.ten.deg <- paste0(region, ".deg.ten.itpa.all", hurr_suf_mar, ".no_drought.rds")
...
png(file.fig.ten.reg.c, width = 7, height = 2.75, unit = "in", res = 600)
p.area.prop
dev.off()
